...
As part of developing and enhancing this project, I contributed the following:

- 📖 **Literature Review**: Researched new research papers on ML & NLP for answer evaluation  
- 🧠 **Model Improvement**: Integrated a new model to increase system accuracy beyond the baseline  
- 📊 **Dataset Preparation**: Designed and curated a high-quality dataset for more robust evaluation 
